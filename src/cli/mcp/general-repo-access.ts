...
import { appendFileSync, closeSync, existsSync, fsyncSync, linkSync, lstatSync, mkdirSync, openSync, readFileSync, readdirSync, realpathSync, renameSync, rmSync, statSync, writeFileSync, writeSync, type Dirent } from 'fs';
import { dirname, join, relative, resolve } from 'path';
import { dlopen } from 'bun:ffi';
import { repoHarnessRegisteredReposPath, type RepoHarnessAccessMode } from '../../effects/repo-registry';
...
import {
  GeneralRepoAccessError,
  assertRepoWriteEnabled,
  isIgnored,
  leafName,
  normalizeRepoRelativePath,
  readIgnorePolicy,
  readStableResolvedFile,
  refreshPathsArg,
  resolveRepo,
  resolveRepoPath,
  resolveRepoWritePath,
  resolveWalkedRepoPath,
  sameIgnorePolicyRevision,
  sha256,
  toPosixPath,
  uniqueRepoRecords,
  type IgnorePolicy,
  ...
  type ResolvedRepoWritePath,
  type SymlinkTargetKind,
} from './general-repo-access/authority';
